...
export const MarkdownMessageRenderer: FC<{ text: string; isStreaming?: boolean }> = React.memo(({ text, isStreaming = false }) => {
...
MarkdownMessageRenderer.displayName = "MarkdownMessageRenderer";
